...
// console.log(designerQuestion('Esther'));
// console.log(otherQuestion('Mark'));

// interviewQuestion('teacher')('Vivian');
...
//         if (style === 'formal') {
//             console.log('Good ' + timeOfDay + ', Ladies and gentlemen! I\'m ' + this.name + ', I\'m a ' + this.job + ' and I\'m a ' + this.age + ' years old.');
...
// function calculateAge(el) { // [1990, 1965, 1937, 2005, 1998] loops through each one and calculate the age
//     return 2016 - el;
// }
